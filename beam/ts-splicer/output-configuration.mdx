---
title: Output streams configuration
...
* **Program number:** Associated to a specific program. Commonly used in MPTS to differentiate programs within the same
  MPEG-2 TS stream.
