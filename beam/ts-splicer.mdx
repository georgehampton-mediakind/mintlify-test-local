---
title: TS Splicing
description: Understand what a TS Splicer does and how MK.IO Beam uses it for ad insertion, blackout, and alternate content switching in live broadcast streams.
sidebarTitle: TS Splicing
---
...
See [Placement configuration](/beam/ts-splicer/placement) for how to set up blackout and alternate content rules.
...
A TS Splicer sits downstream of encoding, receiving a live transport stream and delivering conditioned output to distribution. For workflows where SCTE-35 event management, signal normalization, and rewriting are needed before the TS Splicer, MK.IO Beam's [SCTE-35 Rewriting](/beam/stream-conditioning) capability handles that upstream layer.
