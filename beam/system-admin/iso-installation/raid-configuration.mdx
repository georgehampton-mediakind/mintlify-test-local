---
title: RAID and FakeRAID configuration
description: Supported RAID and FakeRAID configurations for the MK.IO Beam system drive.
sidebarTitle: RAID and FakeRAID configuration
---
