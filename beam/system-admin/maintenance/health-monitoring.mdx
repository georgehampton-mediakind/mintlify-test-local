---
title: Configure health monitoring and remote metrics
sidebarTitle: Health Monitoring
---

<span id="_top" className="mk-legacy-anchor" />

<span id="enabledisable-health-monitoring" className="mk-legacy-anchor" />

## Enable/disable health monitoring

Health monitoring is enabled in MK.IO Beam by default.
If required, it can be disabled to free up server resources.
