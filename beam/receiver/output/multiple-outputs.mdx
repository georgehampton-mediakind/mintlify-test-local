---
title: Configure multiple outputs on a service
sidebarTitle: Multiple Outputs
---
...
![view parameters output sdi cp rx1](/rx1-img/view_parameters_output_sdi_cp_rx1.png)
...
3. Click **+** to add an output.
   ...
   ![view output SDI tabs cp rx1](/rx1-img/view_output_SDI_tabs_cp_rx1.png)
