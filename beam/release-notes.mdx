...
- Third-party software packages now persist across software upgrades
...
- RF cards from Beam appliances now visible in the MK.IO Device page alongside IP and SDI/ASI cards
