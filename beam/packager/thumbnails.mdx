---
title: Adding a thumbnail to a Catalog
sidebarTitle: Thumbnails
---
...
5. Further configuration steps are required in the output settings configuration:
   ...
   * Tick **Enable thumbnails** and configure the [thumbnail layout and periodicity](/beam/packager/hls-dash-over-cmaf-output).

   * You can also configure the thumbnail streams filtering for your manifests for [DASH](/beam/packager/hls-dash-over-cmaf-output) and [HLS](/beam/packager/hls-output) outputs.
