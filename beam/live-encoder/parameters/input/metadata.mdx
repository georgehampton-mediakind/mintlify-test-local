...
| :-------- | :---------------------------------------------------------------------------------------- |
| Type      | Input metadata expected format.{ /* TODO **Note:** {metadata_subtype.recommendations} */} |
...
**Related information**\
[Configure in-band metadata in input stream](/beam/live-encoder/configure/input/inband-metadata)
...
<span id="scte-104ip-oob" className="mk-legacy-anchor" />
...
**Related information**\
[Configure out-of-band metadata in input stream](/beam/live-encoder/configure/input/outofband-metadata)\
[Configure the input](/beam/live-encoder/configure/input)
