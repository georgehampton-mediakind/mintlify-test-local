---
title: Metadata encoding parameters
...
| PTS insertion compensation             | Only available with **Conditioning**.<br />Enable pts insertion compensation.<br />If checked, the pts\_adjustment of an SCTE-35 event will be adjusted so that the splice\_time + pts\_adjustment corresponds to the PTS of the video frame, as illustrated below:<br />![pts insertion compensation](/_machine-assets/d05ea5a8d4ef8a4ad9a93ede6041685fbf4de03f12db44bebfd63cc6f386dc29.png)<br />**Note:** Arm time is the time that separates the SCTE-35 event from its execution. |
...
| Parameter | Description                                                                                                                                                                      |
| :-------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Period    | Target frequency of sending encoded metadata. If higher than the key frame period, encoded metadata will only be present on key frames.<br />Possible values: From 0 to 65535 ms |
