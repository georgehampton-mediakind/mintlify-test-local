---
title: "How Channels Work in MK.IO Beam"
sidebarTitle: "How Channels Work"
description: "Understand the MK.IO Beam channel model — how a channel maps a single input through processing to output, and how it differs from feed-based configuration."
---
