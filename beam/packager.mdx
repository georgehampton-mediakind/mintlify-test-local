---
title: Packaging
description: Understand what a media packager does and how MK.IO Beam uses it to deliver live streams as HLS and DASH for OTT and streaming workflows.
...
The Packager function is not enabled by default on a MK.IO Beam server. You need to enable live packaging in the server's general parameters before creating Packager services. See [Enable Packager](/beam/packager/enable-packager) for instructions.
...
To start configuring outputs, see [Manage Catalogs, outputs and thumbnails](/beam/packager/catalog).
