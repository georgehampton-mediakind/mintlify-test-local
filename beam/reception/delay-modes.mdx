...
3. Select a **Delay mode.**
   ...
   ![view Delay mode setting](/rx1-img/view_delay_mode_cp.png)
...
* Dolby Digital decode requires approximately 15ms of additional processing time which will extend the delay when **Super Low** delay mode is selected.
  Dolby Digital passthrough is not affected.
