...
description: Handle the standard MK.IO error body, recognise the HTTP status codes that appear across the platform, and record what you need to follow up a failure.
...
| `429` | Too Many Requests | Back off and retry later. See [Rate limits](/api-guides/understanding/rate-limits).        |
