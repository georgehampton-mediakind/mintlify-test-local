---
title: Outputs
description: Where a live resource's encoded output goes, destinations, internal outputs, and the archive asset.
...
* [Templates](/api-guides/how-to/live/core-concepts/templates): how encoding templates connect to live resources.
* [Manage live channels and events](/api-guides/how-to/live/manage-live#connect-to-a-destination): create a destination and connect an output to it.
