...
description: spec.state vs status.state, and what the 13 reported state values mean.
...
* **`spec.state`** is what you set. It only ever has two values: `Stopped` or `Running`. This is the desired state described in [Resource types and lifecycle](/api-guides/how-to/live/core-concepts/resource-types).
...
See [Monitor live resources](/api-guides/how-to/live/monitor-live#check-the-current-state) for the reported state values and the rest of the status object.

## What comes next

* [Manage live channels and events](/api-guides/how-to/live/manage-live): create and operate liveChannels and liveEvents.
* [Monitor live resources](/api-guides/how-to/live/monitor-live): metrics, monitoring URLs, and the full status object.
