...
description: "End-to-end recipe: register storage, upload source files, create a transform, submit a job, wait for completion, and publish the output with the Media API."
---
