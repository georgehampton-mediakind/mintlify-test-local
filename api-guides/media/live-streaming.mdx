---
title: "Set Up Live Streaming Events with the Media API"
sidebarTitle: "Live Streaming"
description: "Create live events, configure inputs and outputs, start streaming, and monitor live output state using the MK.IO Media API."
---
