---
title: "MK.IO API Resource Lifecycle States and Transitions"
sidebarTitle: "Resource States"
description: "Understand MK.IO resource lifecycle states for assets, jobs, live events, and endpoints. Monitor state transitions using polling or webhooks."
---
...
<Note>
  The API may also report extra transient states for some resources, such as `Updating`, `Scaling`, or `Error`. The [Media API reference](/api-reference/media-api) lists the complete enum for each resource.
</Note>
