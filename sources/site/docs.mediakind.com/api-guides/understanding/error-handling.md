# Source: https://docs.mediakind.com/api-guides/understanding/error-handling
...
[Section titled “The standard error body”](https://docs.mediakind.com/api-guides/understanding/error-handling/#the-standard-error-body)
...
[Section titled “Status codes across the platform”](https://docs.mediakind.com/api-guides/understanding/error-handling/#status-codes-across-the-platform)
...
| `429` | Too Many Requests | Back off and retry later. See [Rate limits](https://docs.mediakind.com/api-guides/understanding/rate-limits). |
...
[Section titled “A handling order that works”](https://docs.mediakind.com/api-guides/understanding/error-handling/#a-handling-order-that-works)
...
[Section titled “See the status and body together”](https://docs.mediakind.com/api-guides/understanding/error-handling/#see-the-status-and-body-together)
