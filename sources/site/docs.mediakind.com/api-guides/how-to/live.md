# Source: https://docs.mediakind.com/api-guides/how-to/live
...
To see the API working before reading the full model, start with the [walkthrough](https://docs.mediakind.com/api-guides/how-to/live/walkthrough). It builds a complete `liveEvent` and links back to the relevant concepts.

## What this API does

[Section titled “What this API does”](https://docs.mediakind.com/api-guides/how-to/live/#what-this-api-does)
...
[Section titled “When to use the Live API”](https://docs.mediakind.com/api-guides/how-to/live/#when-to-use-the-live-api)
...
[Section titled “How it differs from Media API live events”](https://docs.mediakind.com/api-guides/how-to/live/#how-it-differs-from-media-api-live-events)
...
[Section titled “Media API workflow”](https://docs.mediakind.com/api-guides/how-to/live/#media-api-workflow)
...
[Section titled “Live API workflow”](https://docs.mediakind.com/api-guides/how-to/live/#live-api-workflow)
...
[Section titled “What the Live API depends on”](https://docs.mediakind.com/api-guides/how-to/live/#what-the-live-api-depends-on)

The Live API does not work in isolation. Before you create a live resource, you need resources from two other APIs:

### Media API resources

[Section titled “Media API resources”](https://docs.mediakind.com/api-guides/how-to/live/#media-api-resources)
...
[Section titled “Templates API resources”](https://docs.mediakind.com/api-guides/how-to/live/#templates-api-resources)
...
[Section titled “Start an SRT listener input”](https://docs.mediakind.com/api-guides/how-to/live/#start-an-srt-listener-input)
...
[Section titled “API overview”](https://docs.mediakind.com/api-guides/how-to/live/#api-overview)

| Detail | Value |
| --- | --- |
| Base path | `/api/v1/projects/{project_name}/live/` |
| Scope | Project |
| Reference | [Live API reference](https://docs.mediakind.com/api-reference/live-api) |

## Guides

[Section titled “Guides”](https://docs.mediakind.com/api-guides/how-to/live/#guides)

New to the Live API? Start with the walkthrough for a hands-on introduction, then read Core concepts for the full model.

[Live event walkthrough](https://docs.mediakind.com/api-guides/how-to/live/walkthrough)

### Live event walkthrough

A complete, hands-on example: source, asset, and template through to a running, playable liveEvent.

[Core concepts](https://docs.mediakind.com/api-guides/how-to/live/core-concepts)

### Core concepts

Resource types, billing models, inputs and outputs, transform types, and how templates connect to live resources.

[Manage live channels and events](https://docs.mediakind.com/api-guides/how-to/live/manage-live)

### Manage live channels and events

Create, start, stop, and delete liveChannels and liveEvents with context for each step.

[Multiview](https://docs.mediakind.com/api-guides/how-to/live/multiview)

### Multiview

Compose multiple live inputs into a single output. Covers concepts, both composition modes, and end-to-end setup.

[Scheduled operations](https://docs.mediakind.com/api-guides/how-to/live/scheduled-operations)

### Scheduled operations

Automate start and stop times for any live resource without manual intervention.

[Monitor live resources](https://docs.mediakind.com/api-guides/how-to/live/monitor-live)
