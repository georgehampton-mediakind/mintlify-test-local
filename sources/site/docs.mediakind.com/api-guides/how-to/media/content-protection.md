# Source: https://docs.mediakind.com/api-guides/how-to/media/content-protection
...
This guide builds a working multi-DRM policy. For conceptual background on each DRM system, see the [content protection overview](https://docs.mediakind.com/mkio/understanding/core-concepts/content-protection).

## How the pieces fit together

[Section titled “How the pieces fit together”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#how-the-pieces-fit-together)
...
[Section titled “The minimal working policy”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#the-minimal-working-policy)
...
A successful create returns `201 Created` with the stored policy. A name that already exists returns `409 Conflict`. For the full request and response schema, see the [Media API reference](https://docs.mediakind.com/api-reference/media-api).

## Choosing the configuration

[Section titled “Choosing the configuration”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#choosing-the-configuration)
...
To cover every platform, include all three DRM configurations in one policy, as the minimal example does for two of them. FairPlay is the one configuration that needs extra setup: it requires a Base64-encoded certificate (`fairPlayPfx`), its password (`fairPlayPfxPassword`), and a Base64-encoded application secret key (`ask`). Supply the certificate password directly, without Base64 encoding it. The FairPlay configuration also requires `rentalAndLeaseKeyType` and `rentalDuration`; see `ContentKeyPolicyFairPlayConfiguration` in the [Media API reference](https://docs.mediakind.com/api-reference/media-api) for their supported values. The other systems work with the fields shown above.

Clear Key uses AES-128 and does not reach the security of the three DRM systems. Do not add Clear Key to a policy intended for DRM, because it lowers the overall protection. For the per-system setup detail, see [multi-DRM encryption](https://docs.mediakind.com/mkio/how-to/drm-content-protection/multi-drm-encryption).

## Choosing the restriction

[Section titled “Choosing the restriction”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#choosing-the-restriction)
...
Symmetric (HS256) is the default and the simplest. Choose RSA when your security model requires asymmetric keys; see [RSA key for token validation](https://docs.mediakind.com/mkio/how-to/drm-content-protection/rsa-key-for-token-validation).

## Attach the policy at the locator

[Section titled “Attach the policy at the locator”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#attach-the-policy-at-the-locator)
...
[Section titled “What goes wrong”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#what-goes-wrong)
...
For the token flow and the required claims, see [JWT token authentication](https://docs.mediakind.com/mkio/how-to/drm-content-protection/jwt-token-authentication).

## Related operations

[Section titled “Related operations”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#related-operations)
...
[Section titled “Where to go deeper”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#where-to-go-deeper)

For the concepts and platform-level setup behind these requests:

- [Content protection overview](https://docs.mediakind.com/mkio/understanding/core-concepts/content-protection): how DRM, keys, and licenses work in MK.IO.
- [Multi-DRM encryption](https://docs.mediakind.com/mkio/how-to/drm-content-protection/multi-drm-encryption): per-system configuration detail.
- [JWT token authentication](https://docs.mediakind.com/mkio/how-to/drm-content-protection/jwt-token-authentication): the token flow and claim requirements.
- [Using custom claims in content key policies](https://docs.mediakind.com/mkio/how-to/drm-content-protection/custom-claims): route different licenses from one policy.
...
- [Media API reference](https://docs.mediakind.com/api-reference/media-api).

## What comes next

[Section titled “What comes next”](https://docs.mediakind.com/api-guides/how-to/media/content-protection/#what-comes-next)

- [Streaming and publishing](https://docs.mediakind.com/api-guides/how-to/media/publishing): connect the policy to locators and live playback.