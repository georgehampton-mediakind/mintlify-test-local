# Source: https://docs.mediakind.com/api-guides/how-to/media/content-and-sources
...
[Section titled “Content”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#content)

### Create a content resource

[Section titled “Create a content resource”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#create-a-content-resource)
...
[Section titled “Get and list content”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#get-and-list-content)
...
[Section titled “Update content”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#update-content)

PATCH updates `metadata.displayName` and `metadata.labels` only. Content has no mutable spec fields.

### Delete content

[Section titled “Delete content”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#delete-content)
...
[Section titled “Sources”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#sources)
...
[Section titled “Create a source”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#create-a-source)
...
[Section titled “Update a source”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#update-a-source)
...
Replace `<ENCODER_PUBLIC_IP>` with the encoder’s public IP address. Retrieve the source afterwards and confirm `spec.transport.allowList`. Changes to the destination resource use a different update contract, described under [Destinations](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#destinations).

### Source transport types

[Section titled “Source transport types”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#source-transport-types)

The `transport.type` field determines which other fields apply.

#### SRTListener

[Section titled “SRTListener”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#srtlistener)
...
[Section titled “SRTCaller”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#srtcaller)
...
[Section titled “UDP”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#udp)
...
[Section titled “SDI”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#sdi)
...
[Section titled “HLSPullInput”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#hlspullinput)
...
[Section titled “List and get sources”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#list-and-get-sources)
...
[Section titled “Source state and encoder connections”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#source-state-and-encoder-connections)
...
An established listener connection confirms that the encoder reached the listener. It does not confirm live media flow. After the live resource reaches `Running`, verify the expected video and audio through playback. See [Verify media delivery](https://docs.mediakind.com/api-guides/how-to/live/monitor-live#verify-media-delivery).

### Delete a source

[Section titled “Delete a source”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#delete-a-source)
...
[Section titled “Resolving content”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#resolving-content)
...
If more than one source is attached to the same content name on reachable networks, the platform selects one. This resolution does not by itself guarantee seamless media-aware failover when an encoder stops sending. To select a specific source, reference it directly by `sourceName`. You can also use a [flow input refiner](https://docs.mediakind.com/api-guides/how-to/live/core-concepts/inputs#flow-input-refiners) to narrow the candidates.

### Chain live resources

[Section titled “Chain live resources”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#chain-live-resources)
...
[Section titled “Inspect resolved inputs”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#inspect-resolved-inputs)

Use `?$detailedStatus=true` when reading a live resource’s resolved inputs. Each `status.inputs` entry reports `sourceName` and `sourceDisplayName` for a source, or `upstreamFlowName` for another flow’s output. Resolution still does not confirm media flow. See [Monitor live resources](https://docs.mediakind.com/api-guides/how-to/live/monitor-live) for the full status object and source telemetry.

## Destinations

[Section titled “Destinations”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#destinations)
...
[Section titled “Create a destination”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#create-a-destination)
...
[Section titled “Destination transport types”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#destination-transport-types)
...
[Section titled “List and get destinations”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#list-and-get-destinations)
...
[Section titled “Delete a destination”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#delete-a-destination)
...
[Section titled “What comes next”](https://docs.mediakind.com/api-guides/how-to/media/content-and-sources/#what-comes-next)

- [Manage live channels and events](https://docs.mediakind.com/api-guides/how-to/live/manage-live): create live resources that read from your sources.
- [Multiview](https://docs.mediakind.com/api-guides/how-to/live/multiview): compose multiple source inputs into a single multiview output.
- [Manage templates](https://docs.mediakind.com/api-guides/how-to/templates/manage-templates): create the encoding templates your live resources require.