# Source: https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input

# Configure SMPTE ST 2110 input

## Limitations and Considerations for ST2110 and PTP

[Section titled “Limitations and Considerations for ST2110 and PTP”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#limitations-and-considerations-for-st2110-and-ptp)
...
[Section titled “Configure SDP files on MK.IO Beam”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#configure-sdp-files-on-mkio-beam)

ST 2110 can be configured using SDP files on the **Input** tab of the Live Encoder component (see [Configure an SMPTE ST 2110 input](https://docs.mediakind.com/beam/contribution/configure-feed-components/live-encoder#smpte-st-2110-input)).
...
[Section titled “Configure PTP for ST 2110”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#configure-ptp-for-st-2110)

PTP is required for ST 2110 operation.

### Set the PTP interface and domain

[Section titled “Set the PTP interface and domain”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#set-the-ptp-interface-and-domain)

PTP interface configuration is under the **System Settings** page.

- Navigate to the **Servers** view.
- Click the **Details** ![View][base64-image] button to display the server information.
...
[Section titled “Checking PTP operation”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#checking-ptp-operation)

### How to check that PTP services are running

[Section titled “How to check that PTP services are running”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#how-to-check-that-ptp-services-are-running)
...
[Section titled “How to check the PTP Grand Master”](https://docs.mediakind.com/beam/contribution/how-to/setup-smpte-2110-input/#how-to-check-the-ptp-grand-master)
